...
<div class="col-md-10">
    ...
    <div class="card-deck mt-5">
        <div class="card">
            <img src="https://i.ibb.co/vkphLSK/imgTeam2.jpg" class="card-img-top" alt="...">
        ...
        <div class="card">
            <img src="https://i.ibb.co/XJKRmHP/imgTeam3.jpg" class="card-img-top" alt="...">
            <div class="card-body card-body-cascade text-center">
        ...
        <div class="card">
            <img src="https://i.ibb.co/7kQ93MQ/imgTeam4.jpg" class="card-img-top" alt="...">
            <div class="card-body card-body-cascade text-center">
        ...
        <div class="card">
            <img src="https://i.ibb.co/N6kbqzr/imgTeam5.jpg" class="card-img-top" alt="...">
            <div class="card-body card-body-cascade text-center">
    ...
    <div class="card-deck mt-5">
        <div class="card">
            <img src="https://i.ibb.co/60Ndkcy/img-Team12.jpg" class="card-img-top" alt="...">
            <div class="card-body card-body-cascade text-center">
        ...
        <div class="card">
            <img src="https://i.ibb.co/Lkv3rPg/img-Team13.jpg" class="card-img-top" alt="...">
            <div class="card-body card-body-cascade text-center">
        ...
        <div class="card">
            <img src="https://i.ibb.co/6FL76FR/img-Team14.jpg" class="card-img-top" alt="...">
            <div class="card-body card-body-cascade text-center">
        ...
        <div class="card">
            <img src="https://i.ibb.co/Hrvn6SS/img-Team15.jpg" class="card-img-top" alt="...">
            <div class="card-body card-body-cascade text-center">
...
<!--  Seccion  Servirle  borderServirte-->
